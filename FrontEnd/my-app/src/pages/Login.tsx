...
import { IAuthResponse, ISignupBody, loginApi } from "../apis/auth.apis";
...
export const LoginPage: React.FC = () => {
    ...
    return (
        <div className="w-[430px] h-[920px] m-0 p-4 mx-auto">
            ...
            <Link to={"/"} className="text-6xl font-black">
                 ←
                </Link>
            </div>
            ...
            <div className="w-full space-y-6 p-4 bg-white text-center relative">
                ...
                <div className="relative mb-6 mx-2 text-gray-500 hover:border-black hover:text-black flex justify-center items-center">
                    <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                ...
                <div className="p-4">
                <Link to="/signup" className="font-bold text-xl text-gray-900 text-center active:underline">SignUp</Link>
                </div>
                <button
                    type="submit"
                    onClick={handleLogin}
